<?php 
/**
 * Custom page template for page with slug 'home1'
 *
 * @package AVAZ
 */
 get_header(); ?>
			...
			<div class="section-inner">
				<div class="hero-content uk-grid" data-uk-grid="">
					<div class="uk-width-2-3@s">
						...
						<a class="button uk-button uk-button-large uk-button-default uk-margin-top" href="index.html#avaz__services" data-uk-scroll="">Getting Started</a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="items-listing features-boxes uk-grid uk-grid-match uk-grid-medium uk-child-width-1-3@m" data-uk-grid="">
					<div class="item feature-box uk-active">
						<div class="inner">
							...
							<a href="index.html#" class="link uk-position-cover"></a>
						</div>
					</div>
...
<div class="avaz__content" id="site-content">
	...
	<section class="avaz__services avaz__section uk-section uk-section-large" id="avaz__services">
				...
				<div class="uk-container">
					<div class="items-listing services-boxes uk-grid uk-grid-match uk-grid-medium uk-child-width-1-3@m uk-child-width-1-2@s" data-uk-grid="">
						<div class="item service-box style-one uk-active">
							<div class="inner">
								<i class="overlay-icon icon azmd-line-strategy"></i>
						...
						<div class="item service-box style-one">
							<div class="inner">
								<i class="overlay-icon icon azmd-line-browser"></i>
						...
						<div class="item service-box style-one">
							<div class="inner">
								<i class="overlay-icon icon azmd-line-clipboard"></i>
						...
						<div class="item service-box style-one">
							<div class="inner">
								<i class="overlay-icon icon azmd-line-tools"></i>
						...
						<div class="item service-box style-one">
							<div class="inner">
								<i class="overlay-icon icon azmd-line-target"></i>
	...
	<hr class="avaz__vr__section">
	<section class="avaz__works avaz__section section-slider uk-section uk-section-large" id="avaz__works">
		<div class="section-outer">
			<div class="section-heading">
				<div class="uk-container">
					<div class="inner">
						...
						<div class="right">
							<a class="button uk-button uk-button-default" href="index.html#">View all</a>
						</div>
					</div>
				</div>
			</div>
	...
	<hr class="avaz__vr__section">
	<section class="avaz__about avaz__section uk-section uk-section-large" id="avaz__about">
		<div class="section-outer">
			<div class="section-heading">
				<div class="outer">
					<div class="uk-container">
							...
							<div class="item gallery-box small">
								<div class="outer">
									...
									<div class="inner">
										...
										<a href="index.html#" class="link uk-position-cover" data-uk-toggle=""></a>
									</div>
								</div>
							</div>
							<div class="item gallery-box small">
	...
	<hr class="avaz__vr__section">
	<section class="avaz__clients avaz__section uk-section uk-section-large" id="avaz__clients">
		<div class="uk-container">
			<div class="section-outer">
				<div class="uk-flex uk-flex-middle uk-grid uk-grid-large" data-uk-grid="">
					...
					<div class="left uk-width-2-5@m uk-flex-first">
						<div class="item client-box style-one client-image">
							<div class="image avaz__image__cover avaz__ratio__portrait" data-src="/assets/avaz/images/client_01.jpg" data-uk-img=""></div>
						</div>
					</div>
				</div><!-- Grid End -->
			</div><!-- Outer End -->
	...
	<div class="avaz__clients__logos avaz__section uk-section uk-section-large uk-padding-remove-top" id="avaz__clients__logos">
		<div class="uk-container">
	...
	<hr class="avaz__vr__section">
	<section class="avaz__blog avaz__section section-slider uk-section uk-section-large" id="avaz__blog">
		<div class="section-outer">
					...
					<div class="blog-listing style-one blog-slider owl-carousel" data-items="4" data-loop="true" data-center="true" data-margin="30" data-autoplay="true" data-dots="true">
						<article class="post type-post">
							<div class="outer">
								...
								<div class="inner">
									<a class="category" href="index.html#">Careers</a>
									<h3 class="title uk-h5"><a href="index.html#">Winning tactics for a new digital agency</a></h3>
									<a href="index.html#" class="more icon azmd-arrow-right"></a>
						...
						<article class="post type-post">
							<div class="outer">
								...
								<div class="inner">
									<a class="category" href="index.html#">Opinions / News</a>
									<h3 class="title uk-h5"><a href="index.html#">How I improved my digital in one day</a></h3>
									<a href="index.html#" class="more icon azmd-arrow-right"></a>
									<a href="index.html#" class="link"></a>
								</div>
							</div>
						...
						<article class="post type-post">
							<div class="outer">
								...
								<div class="inner">
									<a class="category" href="index.html#">Design / UX</a>
									<h3 class="title uk-h5"><a href="index.html#">How to make your product stand out</a></h3>
									<a href="index.html#" class="more icon azmd-arrow-right"></a>
									<a href="index.html#" class="link"></a>
								</div>
							</div>
						...
						<article class="post type-post">
							<div class="outer">
								...
								<div class="inner">
									<a class="category" href="index.html#">Marketing</a>
									<h3 class="title uk-h5"><a href="index.html#">Choose from meeting speak, client feedback</a></h3>
									<a href="index.html#" class="more icon azmd-arrow-right"></a>
									<a href="index.html#" class="link"></a>
								</div>
							</div>
