...
<div class="uk-container">
<?php $categories = get_the_terms($post->ID, 'project-category');?>
...
$termsString = ""; foreach ( $termsArray as $term ) { $termsString .= $term->slug.' '; }
$termsList = array(); foreach ( $termsArray as $term ) { array_push($termsList, $term->name); }
?>
