...
/**
 * Class Name: avaz_offcanvas_output
 * Description: A custom WordPress nav walker class to implement UIkit menu markup
 */
class avaz_offcanvas_menu extends Walker_Nav_Menu {
